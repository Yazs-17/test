...
public:
	Player() {
		...
		anim_left = new Anim(atlas_player_left, 45);
		anim_right = new Anim(atlas_player_right, 45);
	}
	~Player() {
		delete anim_left;
		delete anim_right;
...
public:
	Enemy() {
		...
		anim_left = new Anim(atlas_enemy_left, 45);
		anim_right = new Anim(atlas_enemy_right, 45);
